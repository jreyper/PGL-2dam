...
![IMG](./caps-ej1/cap1.png)![IMG](./caps-ej1/cap2.png)

Despues he añadido otros dos `console.log` para mostrar más mensajes.

![IMG](./caps-ej1/cap3.png)![IMG](./caps-ej1/cap4.png)

En el siguiente paso he creado unas variables que nos permiten guardar un dato para utilizarlo después más adelante.

![IMG](./caps-ej1/cap5.png)

Ahora podemos poner dentro de los `console.log` las variables que hemos puesto antes para poder mostrarlas.

![IMG](./caps-ej1/cap6.png)![IMG](./caps-ej1/cap7.png)

También podemos construir una frase usando estas variables como se puede ver en la captura.

![IMG](./caps-ej1/cap8.png)![IMG](./caps-ej1/cap9.png)

Y cuando cambiemos el valor de las variables pues cambiará el resultado.

![IMG](./caps-ej1/cap10.png)![IMG](./caps-ej1/cap11.png)
...
![IMG](./caps-ej2/cap12.png)

Seguidamente muestra unas frases contruídas con esas variables.

![IMG](./caps-ej2/cap13.png)![IMG](./caps-ej2/cap14.png)

Y por último hay un `if`, que lo que hace es que si su `experienciaTotal` es mayor o igual a 100,
puede subir de nivel, y si es menor pues todavía no podrá subir de nivel.

![IMG](./caps-ej2/cap15.png)![IMG](./caps-ej2/cap16.png)

Y ahora podemos comprobar que si se le pone un número menor que 100 en la `experienciaTotal`, no podrá subir de nivel.

![IMG](./caps-ej2/cap17.png)![IMG](./caps-ej2/cap18.png)
